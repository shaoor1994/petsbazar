...
if (itemData.item.category == "Rabbit-Accessories") {
    return (
        ...
        <View style={styles.containerFlate}>
          ...
          >
            <View style={styles.innerContainer}>
              ...
              <View style={{flex:1, marginLeft: -150, marginTop: -20 }}>
...
export default RabbitAccessoriesPics;
