...
if (itemData.item.category == "Bird-Accessories") {
    return (
        ...
        <View style={styles.containerFlate}>
          ...
          >
            <View style={styles.innerContainer}>
              ...
              <View style={{ flex:1,marginLeft: -140, marginTop: -20 }}>
...
export default ParrotAccessoriesPics;
