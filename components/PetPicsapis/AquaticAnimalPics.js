...
if (itemData.item.category == "Aquatic-Animals") {
    return (
        ...
        <View style={styles.containerFlate}>
          ...
          >
            <View style={styles.innerContainer}>
              ...
              <View style={{ marginLeft: -150,marginRight:-20, marginTop: -20,flex:1 }}>
...
export default AquaticAnimalPics;
