...
import WildBirdPics from "../../components/PetPicsapis/WilBirdPics";
import WildAnimalPics from "../../components/PetPicsapis/WildAnimalsPics";
...
export default class WildAnimalScreenHome extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedTab: "",
