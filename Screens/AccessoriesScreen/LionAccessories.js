...
export default class LionAccessoriesScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedTab: "",
            ...
            <View style={styles.petsListView}>
              ...
              >
                ...
                /*  onPress={() => {
                  ...
                  onPress={()=>this.props.navigation.navigate("Lion Accessories")}
                >
                  <Image
                    style={styles.ImageStyling}
                ...
                /*  onPress={() => {
                  ...
                  onPress={()=>this.props.navigation.navigate("Monkey Accessories")}
                >
                  <Image
                    style={styles.ImageStyling}
