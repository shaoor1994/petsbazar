...
const FeaturePetScreenFour = ({ route }) => {
 let url =
    Platform.OS === "android"
    ...
    <View style={styles.mainContainer}>
      <ScrollView>
        ...
        <View style={styles.txtContainer}>
          <Text style={styles.nameTxt}>Baby Monkey</Text>
          ...
          <Text style={styles.desc}>Baby Monkey Available</Text>
        </View>
        <View>
...
export default FeaturePetScreenFour;
