...
const FeaturePetScreenTwo = ({ route }) => {
 let url =
    Platform.OS === "android"
    ...
    <View style={styles.mainContainer}>
      <ScrollView>
        ...
        <View style={styles.txtContainer}>
          <Text style={styles.nameTxt}>Leapord Gecko</Text>
          <Text style={styles.priceTxt}>
            Rs.5000/-
          </Text>

          <Text style={styles.HeadingTxt}>Hyderabad</Text>
          <Text style={styles.HeadingTxt}>Description:</Text>

          <Text style={styles.desc}>Cargo Available all over Pakistan</Text>
        </View>
        <View>
...
export default FeaturePetScreenTwo;
