...
const FeaturePetScreenThree = ({ route }) => {
 let url =
    Platform.OS === "android"
    ...
    <View style={styles.mainContainer}>
      <ScrollView>
        ...
        <View style={styles.txtContainer}>
          <Text style={styles.nameTxt}>Dwarf Rabbit</Text>
          ...
          <Text style={styles.desc}>Adult Dwarf Rabbit Available</Text>
        </View>
        <View>
...
export default FeaturePetScreenThree;
